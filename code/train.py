...
def parse_args():
    ...
    # dir config
    parser.add_argument('--exp_dir', type=str, default='./output/IOLCIA/breastultrasound')
...
#     # IF NECESSARY
#     checkpoint = torch.load('output/IOLCIA/breastultrasound/train-domain[5]/20240420_192923.987180/models/best_model.pth')
#     for keys, md in models.items():
#         pretrained_dict = checkpoint[keys]
#         model_dict = md.state_dict()
#         # 1. filter out unnecessary keys
